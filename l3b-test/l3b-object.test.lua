...
function _G.test_make_subclass()
  ...
  local Foo = Object:make_subclass()
  expect(Foo.__Class).is(Foo)
  expect(Foo.__Super).is(Object)
  local Bar = Foo:make_subclass()
...
_G.test_make_subclass = {
  test_computed = function (_self)
    
    local Class_1 = Object:make_subclass({
      TYPE = "Class_1",
    ...
    local Class_2a = Class_1:make_subclass({
      TYPE = "Class_2a",
      __computed_index = function (self, k)
        if k == "foo_2a" then
          return "bar_2a"
    ...
    local Class_2b = Class_1:make_subclass({
      TYPE = "Class_2b",
      __computed_index = function (self, k)
        if k == "foo_2b" then
          return "bar_2b"
    ...
    local Class_2c = Class_1:make_subclass({
      TYPE = "Class_2c",
    })
  ...
  test_base = function (self)
    ...
    local Class_2  = Class_1:make_subclass()
    expect(Class_2.__Super).is(Class_1)
    local Class_3  = Class_2:make_subclass()
  ...
  test_data = function (_self)
    local Class  = Object:make_subclass({
      foo = "bar",
    })
